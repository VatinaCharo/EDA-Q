...
class Rectanglehollow1(LibraryBase):
    default_options = Dict(
        name="Rectanglehollow10",
        type="Rectanglehollow1",
        chip="chip0",
        gds_pos=(0, 0),
        topo_pos=(0, 0),
        outline=[],
    ...
    def _add_polygons_to_cell(self):
        polygon_data = [
            ...
            ([[0.25, 0.15], [-0.25, 0.15], [-0.25, -0.004056], [-0.093682, -0.004056], [0.1478, 0.060648999999999995], [0.173682, -0.035944], [-0.0678, -0.100649], [-0.093682, -0.004056], [-0.25, -0.004056], [-0.25, -0.15], [0.25, -0.15]], 1),
