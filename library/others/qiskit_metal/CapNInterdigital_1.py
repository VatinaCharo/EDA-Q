...
class Capninterdigital1(LibraryBase):
    default_options = Dict(
        name="Capninterdigital10",
        type="Capninterdigital1",
        chip="chip0",
        gds_pos=(0, 0),
        topo_pos=(0, 0),
        outline=[],
    ...
    def _add_polygons_to_cell(self):
        polygon_data = [
            ...
            ([[-0.005, 0.0], [0.005, 0.0], [0.005, -0.049999999999999996], [-0.005, -0.049999999999999996]], 1),

            ([[-0.005, -0.096], [0.005, -0.096], [0.005, -0.146], [-0.005, -0.146]], 1),

            ([[0.0516, 0.0146], [-0.0516, 0.0146], [-0.0516, -0.102], [-0.043, -0.102], [-0.043, -0.044], [-0.011, -0.044], [-0.011, 0.0], [0.011, 0.0], [0.011, -0.044], [0.043, -0.044], [0.043, -0.102], [0.011, -0.102], [0.011, -0.146], [-0.011, -0.146], [-0.011, -0.102], [-0.043, -0.102], [-0.0516, -0.102], [-0.0516, -0.1606], [0.0516, -0.1606]], 1),

            ([[-0.036, -0.17099999999999999], [-0.036, -0.127], [-0.06799999999999999, -0.127], [-0.06799999999999999, -0.019], [-0.036, -0.019], [-0.036, 0.024999999999999998], [0.036, 0.024999999999999998], [0.036, -0.019], [0.06799999999999999, -0.019], [0.06799999999999999, -0.127], [0.036, -0.127], [0.036, -0.17099999999999999], [-0.036, -0.17099999999999999]], 1),
