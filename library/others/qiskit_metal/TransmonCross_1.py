...
class Transmoncross1(LibraryBase):
    default_options = Dict(
        name="Transmoncross10",
        type="Transmoncross1",
        chip="chip0",
        gds_pos=(0, 0),
        topo_pos=(0, 0),
    ...
    def _add_polygons_to_cell(self):
        polygon_data = [
            ...
            ([[0.264, 0.264], [-0.264, 0.264], [-0.264, -0.03], [-0.22, -0.03], [-0.22, 0.03], [-0.03, 0.03], [-0.03, 0.22], [0.03, 0.22], [0.03, 0.03], [0.22, 0.03], [0.22, -0.03], [0.03, -0.03], [0.03, -0.22], [-0.03, -0.22], [-0.03, -0.03], [-0.22, -0.03], [-0.264, -0.03], [-0.264, -0.264], [0.264, -0.264]], 1),

            ([[-0.245, -0.055], [-0.245, 0.055], [-0.055, 0.055], [-0.055, 0.245], [0.055, 0.245], [0.055, 0.055], [0.245, 0.055], [0.245, -0.055], [0.055, -0.055], [0.055, -0.245], [-0.055, -0.245], [-0.055, -0.055], [-0.245, -0.055]], 1),
