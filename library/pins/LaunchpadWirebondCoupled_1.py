...
class Launchpadwirebondcoupled1(LibraryBase):
    default_options = Dict(
        name="Launchpadwirebondcoupled10",
        type="Launchpadwirebondcoupled1",
        chip="chip0",
        gds_pos=(0, 0),
        topo_pos=(0, 0),
        outline=[],
    ...
    def _add_polygons_to_cell(self):
        polygon_data = [
            ...
            ([[0.0, 0.005], [-0.122, 0.04], [-0.20199999999999999, 0.04], [-0.20199999999999999, -0.04], [-0.122, -0.04], [0.0, -0.005], [0.0625, -0.005], [0.0625, -0.0025], [-0.049999999999999996, -0.0025], [-0.049999999999999996, 0.0025], [0.0625, 0.0025], [0.0625, 0.005], [0.0, 0.005]], 1),

            ([[0.015, -0.0005], [0.06999999999999999, -0.0005], [0.06999999999999999, -0.005], [0.095, -0.005], [0.095, 0.005], [0.06999999999999999, 0.005], [0.06999999999999999, 0.0005], [0.015, 0.0005], [0.015, -0.0005]], 1),

            ([[0.1295, 0.1176], [-0.2845, 0.1176], [-0.2845, -0.09799999999999999], [-0.25, -0.09799999999999999], [-0.25, 0.09799999999999999], [-0.122, 0.09799999999999999], [0.0, 0.011], [0.095, 0.011], [0.095, -0.011], [0.0, -0.011], [-0.122, -0.09799999999999999], [-0.25, -0.09799999999999999], [-0.2845, -0.09799999999999999], [-0.2845, -0.1176], [0.1295, -0.1176]], 1),

            ([[0.008001, 0.036], [0.12, 0.036], [0.12, -0.036], [0.008001, -0.036], [-0.11399899999999999, -0.123], [-0.27499999999999997, -0.123], [-0.27499999999999997, 0.123], [-0.11399899999999999, 0.123], [0.008001, 0.036]], 1),
